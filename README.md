...
| E1 | **Causal SFT.** Standard decoder fine-tuning, causal attention, loss on the answer only | Qwen3-1.7B-Base (full FT); Qwen3-4B-Instruct-2507 and Qwen3-8B (LoRA) | Run. The control. |
