...
Evaluate the final checkpoint on the existing frozen benchmark and log to the training run ID. Repeat E3 and the strongest decoder before claiming a robust advantage; select any hyperparameters on validation only with equal tuning budgets.
